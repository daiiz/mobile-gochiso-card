...
griddles.layout = {
    ...
    "window": {
        ...
        "landscape": {
            ...
            "card_paddings": [0, 0, 0, 0], //[5, 5, 5, 5],
            "card_border_radius": [0, 0, 0, 0] //[2, 2, 2, 2]
        }
    },
    ...
    "nav_items": [
        {"label": "Mobile Gochiso card", "value": "yummy"},
        {"label": "インポート",              "value": "importing"},
        {"label": "削除",                 "value": "removing"},
        {"label": "拡張機能を入手",         "value": "getting"}
    ]
};
